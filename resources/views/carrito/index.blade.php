                            ...
                            <div class="row justify-content-center">
                                <div class="card mb-3" style="max-width: 540px;">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-8">
                                            <div class="card-body"> 
                                            <button class="close" onclick="javascript:remove({{$item->id}},{{$item->total}})"> <span >&times;</span></button>
                                                <h5 class="card-title">{{$item->nombre}}</h5> 
                                                <div class="container">
                                                    <div class="row mb-3">
                                                        <div class="col-md-2">
                                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                                <button onclick="javascript:remove({{$item->id}},1)" type="button" class="btn btn-primary"> - </button>
...
<script type="text/javascript">
 ...
 function remove(x,y){ alert("x"+x + " y"+y);
    $.ajax({
